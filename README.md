...
- 🧠 **Quick things** — a short inbox for today's non-routine tasks and ideas, so you do not have to hold them in your head. The add button lives inside the field, and while the field has focus the bottom menu gets out of the way.
