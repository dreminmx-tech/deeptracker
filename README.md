...
- 📊 **Статистика без осуждения** — полоса-график за 30 или 90 дней на всю ширину: высота столбика показывает, насколько закрыт день, а разбивка по привычкам — компактный список: имя, серия, процент и своя полоска в каждой строке. Ни одного жёлтого пикселя; красный остался только у кнопки «удалить всё».
