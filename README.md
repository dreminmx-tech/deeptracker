...
- 🧹 **Данные без хаоса** — бэкап двумя понятными действиями (скачать / загрузить из файла), вставка JSON спрятана под раскрывашку, удаление — в отдельной «опасной зоне». Приложение помнит, когда файл скачивали в последний раз, и напомнит, если прошло три недели: данные живут только в этом браузере.
