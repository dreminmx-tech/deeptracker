...
import App from './App';
import { layoutReport, layoutSnapshots } from './lib/diagnostics';// Self-hosted variable font (Cyrillic + Latin subsets) — no external requests, works offline.
...
(window as unknown as { deeptrackerLayouts?: () => string[] }).deeptrackerLayouts = layoutSnapshots;
