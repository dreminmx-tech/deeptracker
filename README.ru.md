...
главных дела в день, две цифры в статистике и журнал-лента, куда мысль уходит по Enter.
...
- 📓 **Журнал-лента** — одно поле сверху и один Enter: мысль встаёт в сегодняшний день со своим временем, новые сверху, вчера ниже. Каждое нажатие клавиши уже сохранено, поэтому закрытое приложение ничего не теряет. Заметка правится тапом по ней и не удаляется совсем — именно поэтому случайное движение пальцем ничего не стоит. Любой прошлый день открывается кнопкой «+», если туда нужно что-то дописать.
