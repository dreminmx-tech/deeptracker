...
- 📊 **Статистика из двух цифр и семи точек** — серия, лучшая серия и неделя точками: точка это день, был прогресс или нет. Никаких окон 30/90, полос на тридцать дней и легенд: график, который надо расшифровывать, — ровно то, из-за чего на вкладку статистики не хочется заходить.
...
- 🧠 **Быстрые дела** — короткий инбокс для нерутинных дел и идей на сегодня, чтобы не держать их в голове.
